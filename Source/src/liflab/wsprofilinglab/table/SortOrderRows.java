 ...
 */
public class SortOrderRows implements TableTransformation 
{
	protected String[] m_columnOrder;
	
	public SortOrderRows(String ... row_order)
	{
		super();
		m_columnOrder = row_order;
	}
	...
	public TempTable transform(TempTable... tables)
	{
		...
		Collections.sort(entries, new RowComparator(m_columnOrder));
